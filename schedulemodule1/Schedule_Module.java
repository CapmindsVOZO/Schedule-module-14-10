...
//		Thread.sleep(7000);
		...
		sendkeys(pom.getschedloc().getClcikpatient(), "Martin");
...
//		Clickonelement(pom.getschedloc().getSelectprovider());
		...
		sendkeys(pom.getschedloc().getsearvidpat(), "chris");
...
/////////// Appointment Dashboard ///////
		...
		sendkeys(pom.getschedloc().getClickcalender(), "09/26/2022");
...
//		 Clickonelement(pom.getschedloc().getClickcalender());
		...
		sendkeys(pom.getschedloc().getClickcalender1(), "09/26/2022");
